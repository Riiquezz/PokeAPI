...
const InputFilter = props => {
  ...
  return (
    <React.StrictMode>
      <input id="searchBar" type="text" style={{ display: (bool === true ? 'none' : 'block') }} value={queryFilter} onChange={handleFilterChange} placeholder="Por qual Pokemon você está procurando?" />
    </React.StrictMode>
  );
};
